...
async def cmd_information(message: Message | CallbackQuery, state: FSMContext) -> None | bool:
    await state.clear()
    
    photo = FSInputFile(IMAGES_DIR / "information.jpg")
    msg = _("message_information")
